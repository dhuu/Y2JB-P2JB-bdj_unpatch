...
(async function () {
    try {
        const p2jb_version = "P2JB 1.0 (Y2JB port v2) + bdj_unpatch";
        ...
        async function stage_load_elf(S) {
            ...
            try {
                ...
                for (const name of usb_names) {
                    const p = "/mnt/sandbox/" + get_title_id() + "_000/download0/cache/splash_screen/aHR0cHM6Ly93d3cueW91dHViZS5jb20vdHY=/" + name;
